          ...
          <div className="lg:col-span-3 flex flex-col border-t border-border">
            {experiences.map((exp, index) => (
              <motion.div 
                ...
                className="group border-b border-border py-12 flex flex-col md:flex-row gap-8 md:gap-16 hover:bg-foreground/[0.02] transition-colors -mx-6 px-6 md:-mx-12 md:px-12"
              >
