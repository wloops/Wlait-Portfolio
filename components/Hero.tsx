...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} className="min-h-screen flex flex-col justify-between px-6 md:px-12 pt-32 pb-12 relative overflow-hidden">
      <motion.div style={{ opacity }} className="flex-1 flex flex-col justify-center max-w-7xl mx-auto w-full">
        <motion.div
        ...
        <motion.div style={{ y: y1 }} className="overflow-hidden relative z-30 text-[12vw] sm:text-[10vw] md:text-[8vw] lg:text-[7vw]">
          <motion.h1 
            initial={{ y: "100%" }}
            animate={{ y: 0 }}
        ...
        <motion.div style={{ y: y2 }} className="overflow-hidden relative z-20 text-[12vw] sm:text-[10vw] md:text-[8vw] lg:text-[7vw] -mt-[0.3em]">
          <motion.h1 
            initial={{ y: "100%" }}
            animate={{ y: 0 }}
