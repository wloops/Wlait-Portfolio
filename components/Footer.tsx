      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 pt-12 border-t border-background/20">
          ...
          <div className="flex gap-8">
            <Link href="https://github.com/wloops" target="_blank" className="font-mono text-xs text-background/60 hover:text-background transition-colors uppercase tracking-widest">
              GitHub
            </Link>
          </div>
